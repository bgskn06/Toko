...
class RegisterScreen(FloatLayout):
    def __init__(self, **kwargs):
        ...
        self.label_password = Label(text = 'Password', size_hint_y = None, height = 40)
        ...
        self.label_alamat = Label(text = 'Alamat', size_hint_y = None, height = 40)
        ...
        self.label_noHp = Label(text = 'No HP', size_hint_y = None, height = 40)
        ...
        self.label_role = Label(text = 'Daftar Sebagai', size_hint_y = None, height = 40)
        ...
        self.tombol_daftar = Button(text = 'Daftar', size_hint_y = None, height = 50, padding_x = 20)
